...
function manhattan_distance(node)
    [p,o] = ind2sub(size(f), node);
    dist = abs(start_coords(1)-p) + abs(start_coords(2)-o);
    g(node) = dist;
